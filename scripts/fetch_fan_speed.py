...
class reader:
   ...
   """
   def __init__(self, pi, gpio, pulses_per_rev=1.0, weighting=1.0, min_RPM=5.0):
      """
...
if __name__ == "__main__":
   ...
   import fetch_fan_speed

   RPM_GPIO = config['hall']['pin']
   SAMPLE_TIME = config['hall']['sample_time']

   pi = pigpio.pi()

   p = fetch_fan_speed.reader(pi, RPM_GPIO)
